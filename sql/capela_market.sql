...
(1, 1, 8, 'Cutelo Inox 07 Profissional Linha Premium - Corneta 7555407 Cor Cor: Cabo Branco', 'cutelo-inox-07-profissional-linha-premium-corneta-7555407-cor-cor-cabo-branco', 'Unidades por kit: 1. | Lâmina de aço inoxidável para durabilidade e resistência à corrosão. | Versátil, ideal para cortar carne, peixe, frango, coco e ossos. | Cabo de plástico branco, proporcionando um manuseio confortável. | Embalagem contém uma unidade, perfeita para uso profissional em açougues e frigoríficos.', 40.47, 37.23, 30, 'ACO-0001', 'real-acougue-01.webp', 'aprovado', 0, 0, '2026-03-09 13:24:21', '2026-03-09 13:24:21'),
...
(15, 1, 26, 'Presente Azulejo Lar Doce Lar Família Personalizad Casa Nova Cor Branco | Parcelamento sem juros', 'presente-azulejo-lar-doce-lar-fam-ilia-personalizad-casa-nova-cor-branco-parcelamento-sem-juros', 'Altura: 20 cm. | Largura: 20 cm. | Unidades por kit: 1. | Formato de venda: Unidade. | Cor da armação: Preto. | Com frases.', 53.24, 48.98, 26, 'DEC-0102', 'real-decoracao-102.webp', 'aprovado', 0, 0, '2026-03-09 13:32:35', '2026-03-09 13:32:35'),
